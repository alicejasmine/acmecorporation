...
For enhanced security, the database connection string is retrieved from the "sqlconn" environment variable. Refer to Utilities.cs in the infrastructure folder for connection string details.
